...
<div style="text-align: left;">
    <figure style="display: inline-block; margin: 0;">
        ...
        <figcaption style="text-align: center; max-width: 800px; font-weight: bold; font-size: 14px; margin-top: -20px; color: #555;">图1. 交易流程</figcaption>
    </figure>
</div>
...
Gateway 之前需要对交易交易进行去重、签名验证。前者目的是在交易池的广播过程中去除重复的交易，减少广播重复交易的带宽消耗和计算消耗。后者的目的是验证交易签名的有效性。若不合法或者重复交易产生，将会被直接丢弃，不进入交易池。若合法则会通过P2P网络对交易进行广播，让交易尽可能到达所有节点。
