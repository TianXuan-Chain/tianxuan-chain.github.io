...
<div style="text-align: left;">
    <figure style="display: inline-block; margin: 0;">
        ...
        <figcaption style="text-align: center; max-width: 1000px; font-weight: bold; font-size: 14px; margin-top: -20px; color: #555;">图1. 整体架构</figcaption>
    </figure>
</div>
...
天玄针对联盟链场景，对存储模型进行了优化，去除了MPT树的索引结构，减少了在执行是对MPT树的检索。底层使用 LevelDB 作为持久化存储引擎，以支持海量数据。
